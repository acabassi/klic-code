...
ari_comparison <- cbind(ari_all, ari_coca)
...
ggplot(data = ari_comparison.m, aes(x=Method, y=ARI)) + geom_boxplot() + ylim(0,1) + my_theme
ggsave("coca-a.pdf", width = 6, height = 10, units = "cm")
